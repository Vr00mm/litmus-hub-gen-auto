...
func generateExperiment(composant resources.Object, container string) types.ChaosChart {
	exp := ExperimentsManifests["pod-network-latency"]
	exp.ChaosExperiment.Metadata.Name = "pod-network-latency-" + composant.GetName() + "-" + container
	...
	expParameters.Name = "pod-network-latency-" + composant.GetName() + "-" + container
...
func Generate(composant resources.Object) []types.ChaosChart {
	...
	for container := range containers {
		...
		exp.TemplateName = "pod-network-latency"
